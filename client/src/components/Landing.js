...
function Landing() {
    return (
        ...
        <footer className="text-center fixed">Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://twitter.com/_Anjali19_"target="_blank">Anjali</a></footer>
        </>
    )
}
